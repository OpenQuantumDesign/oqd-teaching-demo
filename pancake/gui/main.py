...
class LabInterfaceApp(QMainWindow):
    ...
    def initialize_system_connections(self):
        print("Initialize system connections")
        return

    def closeEvent(self, event):
        print("Close system connections")
        return
...
class TabManager(QWidget):
    def __init__(self, parent):
        ...
        self.tab2 = QuickEquipmentControlTab(self)
        self.tabs.addTab(self.tab2, "Quick Control")

        self.tab3 = RunMeasurementsTab(self)
        self.tabs.addTab(self.tab3, "Run Measurements")
...
class RealTimeDataDock(QWidget):
    def __init__(self, parent):
        ...
        self.tab2 = PlotOpticalPower(self, powermeter=system.powermeter, ui_config=ui_config)
...
class PhotonStatisticsMonitor(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.plot = PlotLogicGrid(self, timetagger=system.timetagger, ui_config=ui_config,
...
class FullEquipmentControlTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        layout.addWidget(self.laser_control_panel)

        self.timetag_control_panel = ControlPanelTimeTag(self)
        layout.addWidget(self.timetag_control_panel)

        self.waveplate_control_panel = ControlPanelWaveplate(self)
        layout.addWidget(self.waveplate_control_panel)

        self.function_generator_control_panel = ControlPanelFunctionGenerator(self)
        layout.addWidget(self.function_generator_control_panel)
